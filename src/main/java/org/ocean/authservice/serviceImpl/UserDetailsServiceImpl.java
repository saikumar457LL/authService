                ...
                .map(user -> UserDetailsDao.builder()
                        ...
                        .userProfileDao(
                                UserProfileDao.builder()
                                        .first_name(user.getUserProfile().getFirst_name())
                                        .last_name(user.getUserProfile().getLast_name())
                                        .date_of_birth(user.getUserProfile().getDate_of_birth())
                                        .joining_date(user.getUserProfile().getJoining_date())
